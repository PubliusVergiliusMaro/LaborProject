...
namespace LaborProjectOOP.Dekstop.Views.Pages
{
	...
	public partial class AdminMenuPage : Page
	{
		...
		private void enterAsCustomerBtn_Click(object sender, RoutedEventArgs e)
		{
			...
			//.Navigate(new CustomerMainPage(_bookService, _orderService, _orderService, _orderService, _orderService, _authorService, _wishListService,_cartListService,customer,true));
		}
